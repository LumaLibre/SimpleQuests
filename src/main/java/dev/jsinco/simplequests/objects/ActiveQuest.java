...
public class ActiveQuest extends Quest {
    ...
    public ActiveQuest(int progress, String category, String id, String name, String type, QuestAction questAction, int amount, @Nullable RewardType rewardType, @Nullable Object rewardValue, @Nullable Material menuItem) {
        super(category, id, name, type, questAction, amount, rewardType, rewardValue, menuItem);
        this.progress = progress;
    }

    public ActiveQuest(Quest quest) {
        super(quest.getCategory(), quest.getId(), quest.getName(), quest.getType(), quest.getQuestAction(), quest.getAmount(), quest.getRewardType(), quest.getRewardValue(), quest.getMenuItem());
        this.progress = 0;
    }
